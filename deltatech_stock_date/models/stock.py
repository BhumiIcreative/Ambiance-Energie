            ...
            if not use_date:
                for picking in self:
                    ...
                    if "date_done" in vals:
                        date = fields.Date.to_date(vals["date_done"])
                        picking_date = fields.Date.to_date(picking.date_done)
                        if picking_date < today and picking_date < date:
                            vals["date_done"] = picking_date
            else:
                if "date_done" in vals:
                    vals["date_done"] = use_date
